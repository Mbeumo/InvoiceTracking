...
import { User,Invoice, InvoiceHistory, InvoiceStatus } from '../types/DatabaseModels';
//import { User } from '../types/auth';
//import { services, users, invoiceHistory } from '../mock-data/invoices';
import {
    X,
    Calendar,
    User as UserIcon,
...
export const InvoiceDetails: React.FC<InvoiceDetailsProps> = ({ invoice, user, onClose, onUpdate }) => {
    ...
    const handleStatusChange = (newStatus: InvoiceStatus, comment?: string) => {
        ...
        // Dans une vraie application, on ajouterait �galement l'entr�e � l'historique
        setComment('');
    };
    ...
    const getNextActions = () => {
        ...
        switch (invoice.status) {
            ...
            case 'in_payment':
                if (user.permissions.includes('approve_invoice')) {
                    actions.push(
                        { label: 'Marquer comme pay�e', status: 'paid', color: 'green' }
                    );
                }
                break;
        }
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center p-6 border-b">
                    <h2 className="text-2xl font-bold text-gray-900">D�tails de la facture</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <p className="text-sm">Cr��e le {new Date(invoice.createdDate).toLocaleDateString('fr-FR')}</p>
                                            <p className="text-sm">�ch�ance le {new Date(invoice.dueDate).toLocaleDateString('fr-FR')}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">Assign�e �</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    {user.permissions.includes('transfer_invoice') && (
                        <div>
                            <h3 className="text-lg font-semibold text-gray-900 mb-3">Transf�rer vers un service</h3>
                            <div className="flex flex-wrap gap-2">
