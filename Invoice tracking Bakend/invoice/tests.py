...
#     mocker.patch("invoice.views.get_image_from_uploaded_file", return_value=None)
#     mocker.patch("invoice.views.perform_ocr_and_extract_data", return_value=(
#         {
...
#     assert existing_invoice.tax_amount == 2000
#     assert existing_invoice.subtotal == 33333
